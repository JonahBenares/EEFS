...
if (isset($_POST['export_excel']) && !empty($_SESSION['export_data'])) {
    ...
    header("Content-Disposition: attachment; filename=summary_report_export.xls");
    ...
    echo "
        ...
        <tr>
            <td colspan='6' style='font-size:20px; font-weight:bold; text-align: center'>EEFS Summary Report</td>
        </tr>
        <tr>
